...
do
  ...
  do
    ...
    do  
        ...
        cp RWinput_param_1_1_10.yaml IGinput_param_greedy_1_1.yaml
        sed -i -e "s/_SEED_/$c/g" IGinput_param_greedy_1_1.yaml
        sed -i -e "s/_NUM_OF_AGENTS_/$x/g" IGinput_param_greedy_1_1.yaml
        sed -i -e "s/_COMMUNICATIONS_RANGE_/$y/g" IGinput_param_greedy_1_1.yaml
        sed -Ei "s|_PATH_|$LOCALPATH|g" IGinput_param_greedy_1_1.yaml
        /home/rococoadmin/CarlosCarbone/SwarmSimulators/01_UAVswarmInspectionSimulator/release/build/MACPP -i IGinput_param_greedy_1_1.yaml
    done	
  done
done
