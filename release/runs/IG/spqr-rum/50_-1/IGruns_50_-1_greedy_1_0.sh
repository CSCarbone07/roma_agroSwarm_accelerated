...
do
  ...
  do
    ...
    do  
        ...
        cp IGinput_param_50_-1_greedy_1_0.yaml IGfound_param_50_-1_greedy_1_0.yaml
        sed -i -e "s/_SEED_/$c/g" IGfound_param_50_-1_greedy_1_0.yaml
        sed -i -e "s/_NUM_OF_AGENTS_/$x/g" IGfound_param_50_-1_greedy_1_0.yaml
        sed -i -e "s/_COMMUNICATIONS_RANGE_/$y/g" IGfound_param_50_-1_greedy_1_0.yaml
        sed -Ei "s|_PATH_|$LOCALPATH|g" IGfound_param_50_-1_greedy_1_0.yaml
        /home/rococoadmin/CarlosCarbone/SwarmSimulators/01_UAVswarmInspectionSimulator/release/build/MACPP -i IGfound_param_50_-1_greedy_1_0.yaml
    done	
  done
done
