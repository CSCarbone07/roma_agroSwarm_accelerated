    ...
    do
      ...
      do
        ...
        do  
            ...
            cp RWinput_param_0_8.yaml RWparam_found_script_0_8.yaml
            sed -i -e "s/_SEED_/$c/g" RWparam_found_script_0_8.yaml
            sed -i -e "s/_NUM_OF_AGENTS_/$x/g" RWparam_found_script_0_8.yaml
            sed -i -e "s/_COMMUNICATIONS_RANGE_/$y/g" RWparam_found_script_0_8.yaml
            sed -i -e "s/_ATTRACTION_/$i/g" RWparam_found_script_0_8.yaml
            sed -i -e "s/_REPULSION_/$j/g" RWparam_found_script_0_8.yaml
            sed -Ei "s|_PATH_|$LOCALPATH|g" RWparam_found_script_0_8.yaml
            /home/cscarbone/SwarmSimulators/01_UAVswarmInspectionSimulator/release/build/MACPP -i RWparam_found_script_0_8.yaml
        done
      done
    done	
  done
